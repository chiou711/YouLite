...
public class Mail_filesListJson extends ListFragment
{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        rootView = inflater.inflate(R.layout.import_sd_json_files_list, container, false);
        ...
        else
        {
            ...
            else
            {
                    ...
                    file.getName().contains("json")     ))
            	{
                    ...
                    Mail_fileViewJson fragment = new Mail_fileViewJson();
