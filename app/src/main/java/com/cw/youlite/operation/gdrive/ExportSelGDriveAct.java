 ...
 */
public class ExportSelGDriveAct extends AppCompatActivity {
    private static final String TAG = "ExportSelGDriveAct";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        assert bundle != null;
        jsonContent = bundle.getString("SEL_JSON");
        mDocContentEditText.setText(jsonContent);
        jsonContent = bundle.getString("FILE_NAME");
        mFileTitleEditText.setText(bundle.getString("FILE_NAME"));
    }
