...
public class Export_toSDCardJsonFragment extends Fragment {
	Context mContext;
	TextView title;
	...
	public Export_toSDCardJsonFragment(){}
	...
	public class ShowProgressBarAsyncTask extends AsyncTask<Void, Integer, Void> {
		...
		protected Void doInBackground(Void... params) {
			...
			try {
				//todo Can not export too many pages?
				util.exportToSdCardJson(mStrSDCardFileName, // attachment name
