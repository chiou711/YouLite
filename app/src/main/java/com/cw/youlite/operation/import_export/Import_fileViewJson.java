...
public class Import_fileViewJson extends Fragment
{
...
//		getActivity().getActionBar().setDisplayShowHomeEnabled(false);
				...
				builder1.setTitle(R.string.confirm_dialog_title)
						...
						.setPositiveButton(R.string.confirm_dialog_button_yes, new DialogInterface.OnClickListener()
						{
							...
							public void onClick(DialogInterface dialog1, int which1)
							{
                                ...
                                Import_filesListJson fragment = ((Import_filesListJson)getActivity().getSupportFragmentManager().findFragmentByTag("import"));
		...
		confirmButton.setOnClickListener(new View.OnClickListener()
		{
			...
			public void onClick(View view)
			{
				Import_fileViewJson_asyncTask task = new Import_fileViewJson_asyncTask(MainAct.mAct,rootView,filePath);
